# Install Data Virtualization Service on Cloud Pak for Data
...
```hcl-terraform
module "cp-data-virtualization-service" {
  source = "github.com/cloud-native-toolkit/terraform-gitops-cp-data-virtualization-service.git"
